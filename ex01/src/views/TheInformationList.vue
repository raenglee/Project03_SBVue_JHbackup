...
<!--🐎말머리 선택-->
        <div>
            ...
            <input type="checkbox">동티모르
            <input type="checkbox">라오스
            <input type="checkbox">말레이시아
            <input type="checkbox">미얀마
            <input type="checkbox">베트남
            <input type="checkbox">브루나이
            <input type="checkbox">싱가포르
            <input type="checkbox">인도네시아
            <input type="checkbox">캄보디아
            <input type="checkbox">태국
            <input type="checkbox">필리핀
        </div>

        <div>
            <input type="checkbox">전체
            <input type="checkbox">교통
            <input type="checkbox">맛집
            <input type="checkbox">문화 체험
            <input type="checkbox">쇼핑
            <input type="checkbox">숙박
            <input type="checkbox">액티비티
            <input type="checkbox">여행 스팟
            <input type="checkbox">항공권
            <input type="checkbox">후기
